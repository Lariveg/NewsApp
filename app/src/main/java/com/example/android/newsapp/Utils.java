...
public final class Utils {
    ...
    /**
     * Query the GOOGLE BOOK API dataset and return a list of {@link News} objects.
     */
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // For each piece of news in the resultsArray, create an {@link News} object
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                if (currentNews.has("sectionName")) {
                    ...
                    section = "No section was found.";
                }

                // Extract the value for the key called "webUrl"
                url = currentNews.getString("webUrl");

                // Create a new {@link News} object with the title and the section from the JSON response.
